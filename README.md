...
```bash
# Step 1: MSSQL 基准（必须全部通过）
APP_ACTIVE_DB=mssql pytest tests/test_baseline_crud.py -v

# Step 2: SQL 编译对比（无需数据库连接）
...
│       └── versions/
├── tests/
│   ├── conftest.py            # 三库 parametrize fixtures
