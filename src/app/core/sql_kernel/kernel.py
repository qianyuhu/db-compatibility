...
Usage:
    from app.core.sql_kernel import SQLKernel
...
class SQLKernel:
    ...
    def execute_on_both(
        ...
        *,
        ...
        """
        from app.services.executor import DualDbExecutor
...
def _run_score(ctx: SQLSemanticContext):
    ...
    """
    from app.api.sql_compare.score_service import calculate_score_from_context
